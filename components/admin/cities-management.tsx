    ...
    <div className="min-h-screen bg-gray-50 text-slate-900">
          ...
          <div className="flex items-start sm:items-center space-x-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm">Manage cities in the platform</p>
              </div>
            </div>
          </div>
          <div className="flex items-start sm:items-center space-x-3">
            ...
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              ...
              <DialogContent className="max-w-2xl bg-white border-gray-200">
                <DialogHeader>
                  <DialogTitle className="text-slate-900">Add New City</DialogTitle>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="name" className="text-slate-800">City Name</Label>
                    <Input
                      id="name"
                      value={newCity.name}
                    ...
                    <Select onValueChange={(value) => setNewCity({ ...newCity, country: value })}>
                      ...
                      <SelectContent className="bg-white border-gray-200">
                        {countries.map(country => (
                          <SelectItem key={country} value={country} className="text-slate-900 hover:bg-gray-50">
                            {country}
                          </SelectItem>
                        ))}
                      </SelectContent>
                  ...
                  <div>
                    <Label htmlFor="latitude" className="text-slate-800">Latitude</Label>
                    <Input
                      id="latitude"
                      type="number"
                      step="any"
                  ...
                  <div>
                    <Label htmlFor="longitude" className="text-slate-800">Longitude</Label>
                    <Input
                      id="longitude"
                      type="number"
                      step="any"
                  ...
                  <div>
                    <Label htmlFor="cost_index" className="text-slate-800">Cost Index (1-100)</Label>
                    <Input
                      id="cost_index"
                      type="number"
                      min="1"
                  ...
                  <div>
                    <Label htmlFor="timezone" className="text-slate-800">Timezone</Label>
                    <Input
                      id="timezone"
                ...
                <div className="flex justify-end gap-2 mt-4">
                  ...
                  <Button onClick={handleAddCity} className="bg-emerald-600 hover:bg-emerald-700">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {isLoading ? (
            ...
            filteredCities.map(city => (
              <Card key={city.id} className="bg-white border-gray-200 shadow-md overflow-hidden">
                ...
                <CardContent className="p-4">
                  <div className="flex items-start justify-between mb-2">
                    <h3 className="text-slate-900 font-semibold text-lg">{city.name}</h3>
                  ...
                  <div className="flex items-center justify-between text-xs text-slate-600">
                    ...
                    <span className="text-slate-500">ID: {city.id}</span>
                  </div>
                </CardContent>
              </Card>
            ))
            ...
            <div className="col-span-full text-center py-12">
              ...
              <p className="text-slate-700 text-lg">No cities found</p>
              <p className="text-slate-600 text-sm">Try adjusting your search or add a new city</p>
            </div>
          )}
        </div>
        ...
        <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
          <DialogContent className="max-w-2xl bg-white border-gray-200">
            <DialogHeader>
              <DialogTitle className="text-slate-900">Edit City</DialogTitle>
              <DialogDescription className="text-slate-600">
            ...
            {editingCity && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="edit-name" className="text-slate-800">City Name</Label>
                  <Input
                    id="edit-name"
                ...
                <div>
                  <Label htmlFor="edit-country" className="text-slate-800">Country</Label>
                  <Select 
                ...
                <div>
                  <Label htmlFor="edit-latitude" className="text-slate-800">Latitude</Label>
                  <Input
                    id="edit-latitude"
                    type="number"
                    step="any"
                ...
                <div>
                  <Label htmlFor="edit-longitude" className="text-slate-800">Longitude</Label>
                  <Input
                    id="edit-longitude"
                    type="number"
                    step="any"
                ...
                <div>
                  <Label htmlFor="edit-cost_index" className="text-slate-800">Cost Index (1-100)</Label>
                  <Input
                    id="edit-cost_index"
                    type="number"
                    min="1"
                ...
                <div>
                  <Label htmlFor="edit-timezone" className="text-slate-800">Timezone</Label>
                  <Input
                    id="edit-timezone"
            ...
            <div className="flex justify-end gap-2 mt-4">
              ...
              <Button onClick={handleEditCity} className="bg-emerald-600 hover:bg-emerald-700">
                <Save className="w-4 h-4 mr-2" />
                Save Changes
              </Button>
            </div>
